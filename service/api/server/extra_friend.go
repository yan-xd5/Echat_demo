...
func (s *extraFriendImpl) BlacklistFriend(ctx context.Context) {
	...
	if err != nil || f == nil {
		writeJSON(ctx, w, 400, map[string]interface{}{"code": 1, "message": "好友关系不存在"})
		return
	}
	...
	writeJSON(ctx, w, 200, map[string]interface{}{"code": 0, "message": "已拉黑"})
}
...
func (s *extraFriendImpl) UnblacklistFriend(ctx context.Context) {
	...
	writeJSON(ctx, w, 200, map[string]interface{}{"code": 0, "message": "已取消拉黑"})
}
